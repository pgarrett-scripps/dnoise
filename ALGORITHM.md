...
padded region is kept over its whole extent (0.4.0 stopped it 0.1 1/K0 beyond
the mobility range of its inside points). Both MS1 gates are
...
5 Th / 0.05 1/K0 pads reproduces 0.3.0.
